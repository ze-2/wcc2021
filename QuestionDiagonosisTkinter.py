...
#        self.txtDigonosis.insert(END,str1+"\n")
    ...
    def btnStart_Click(self):
        ...
        self.txtDigonosis.delete(0.0,END)
        self.txtQuestion.delete(0.0,END)
        self.txtDigonosis.insert(END,"Welcome to Doc-On" + "\n" + "\n")
...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblMsg.pack()
        self.lblMsg=Label(self, text="Doc-On Chatbot", bg="light blue", width="300", height="1", font=("PosterBodoni BT", 26 ,"bold italic"))
        self.lblMsg.pack()
        self.lblMsg=Label(self, text=" ", width="300", height="2", font=("Calibri", 13))
        self.lblMsg.pack()
...
class Login(Frame):
    ...
    def createWidget(self):
        ...
        self.lblMsg.pack()
        self.lblMsg=Label(self, text="Doc-On Chatbot", bg="light blue", width="300", height="1",  font = ("times" , 26, "bold italic"))
        self.lblMsg.pack()
        self.lblMsg=Label(self, text=" " ,  font = ("times" , 22, "bold"))
        self.lblMsg.pack()
...
class SignUp(Frame):
    ...
    def createWidget(self):
        ...
        self.lblMsg=Label(self, text="Doc-On Chatbot", bg="light blue" , width="300", height="1", fg = "black" , font = ("times" , 26, "bold italic"))
        self.lblMsg.pack()
